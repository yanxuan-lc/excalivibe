...
".agents/skills/notify-user/scripts/notify.sh" --doctor
```
...
```bash
".agents/skills/notify-user/scripts/notify.sh" --init     # writes the config, both lines live
".agents/skills/notify-user/scripts/notify.sh" --doctor   # prove it, with a real banner
```
