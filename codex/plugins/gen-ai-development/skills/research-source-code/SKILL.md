...
description: Clone a library at the exact tag/branch/commit and study the real source with SHA-level provenance — dispatched by research-pipeline / researcher for source-grounded questions.
---
