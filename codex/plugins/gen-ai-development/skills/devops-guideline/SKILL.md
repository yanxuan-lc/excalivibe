...
description: "Repository DevOps conventions for task-runner commands, local docker-compose dependencies, Dockerfiles, and repo-side CI entry points. Use when creating, editing, or explaining build/test/run infrastructure."
---
