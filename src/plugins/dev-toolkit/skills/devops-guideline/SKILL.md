...
description: "Decide how a repository is driven from the command line, and apply the conventions instead of inventing them — which single front door every build, test, lint, format and run command goes through, what runs as a local dependency container versus what ships inside the image, and how that image is built so it stays small, non-root and buildable from China. Carries the concrete conventions for Makefile, justfile, npm scripts and Taskfile, for a dev-dependency compose file (DB, MQ, cache), and for a multi-stage Dockerfile. Reach for it whenever work adds or changes an entry point — a task-runner target, a compose service for local deps, a Dockerfile stage, or the repo-side commands CI invokes — and whenever the question is only \"how do I run this here\", including when no file is named and nobody says \"guideline\". It answers how the repository is operated from the outside; how a running service integrates with the platform it is deployed onto is a different question."
description-claude: "Decide how a repository is driven from the command line, and apply the conventions instead of inventing them — which single front door every build, test, lint, format and run command goes through, what runs as a local dependency container versus what ships inside the image, and how that image is built so it stays small, non-root and buildable from China. Carries the concrete conventions for Makefile, justfile, npm scripts and Taskfile, for a dev-dependency compose file (DB, MQ, cache), and for a multi-stage Dockerfile. Reach for it whenever work adds or changes an entry point — a task-runner target, a compose service for local deps, a Dockerfile stage, or the repo-side commands CI invokes — and whenever the question is only \"how do I run this here\", including when no file is named and nobody says \"guideline\". It answers how the repository is operated from the outside; how a running service integrates with the platform it is deployed onto is a different question."
description-codex: "Decide how a repository is driven from the command line, and apply the conventions instead of inventing them — which single front door every build, test, lint, format and run command goes through, what runs as a local dependency container versus what ships inside the image, and how that image is built so it stays small, non-root and buildable from China. Carries the concrete conventions for Makefile, justfile, npm scripts and Taskfile, for a dev-dependency compose file (DB, MQ, cache), and for a multi-stage Dockerfile. Reach for it whenever work adds or changes an entry point — a task-runner target, a compose service for local deps, a Dockerfile stage, or the repo-side commands CI invokes — and whenever the question is only \"how do I run this here\", including when no file is named and nobody says \"guideline\". It answers how the repository is operated from the outside; how a running service integrates with the platform it is deployed onto is a different question."
---
