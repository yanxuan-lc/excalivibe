...
description: Decide how a service should integrate with the platform it runs on, and apply the conventions rather than inventing them — how it finds its configuration and what it does when that source is unreachable, whether config reloads live or needs a restart, where credentials live, and what every service must expose before operations can see it at all (liveness, readiness, metrics). Reach for it when scaffolding a backend service and asking what it still needs to be considered done, when shaping its API surface, when wiring config loading, or when adding a monitoring surface. The concrete implementation described is a Nacos config centre and Prometheus metrics, but the questions it answers are design questions about the service side — not diagnosing an outage in the middleware itself, and not querying or charting metrics once they are exposed.
description-claude: Decide how a service should integrate with the platform it runs on, and apply the conventions rather than inventing them — how it finds its configuration and what it does when that source is unreachable, whether config reloads live or needs a restart, where credentials live, and what every service must expose before operations can see it at all (liveness, readiness, metrics). Reach for it when scaffolding a backend service and asking what it still needs to be considered done, when shaping its API surface, when wiring config loading, or when adding a monitoring surface. The concrete implementation described is a Nacos config centre and Prometheus metrics, but the questions it answers are design questions about the service side — not diagnosing an outage in the middleware itself, and not querying or charting metrics once they are exposed.
description-codex: Decide how a service should integrate with the platform it runs on, and apply the conventions rather than inventing them — how it finds its configuration and what it does when that source is unreachable, whether config reloads live or needs a restart, where credentials live, and what every service must expose before operations can see it at all (liveness, readiness, metrics). Reach for it when scaffolding a backend service and asking what it still needs to be considered done, when shaping its API surface, when wiring config loading, or when adding a monitoring surface. The concrete implementation described is a Nacos config centre and Prometheus metrics, but the questions it answers are design questions about the service side — not diagnosing an outage in the middleware itself, and not querying or charting metrics once they are exposed.
---
