...
description: Answer "how should this be written here" from the project's recorded conventions rather than by inferring them from nearby code — what to name something, whether to split a module, what a function does with an error, how much to comment, which logging library to use and how to configure it, how to structure something new. Carries those conventions plus a per-language reference for TypeScript, JavaScript, React, React Native, Python, Go, Rust, Swift, Dart and Flutter. Reach for it whenever you are choosing between ways to write something, or judging whether existing code follows the conventions, including when the question names no language at all — "should this return null or throw", "should these be two modules or one", "this function has grown too long, how do I break it up", "what should I call this one", "what pattern do we use for errors here", "how much should I comment this". Surrounding code shows what was done, which is not the same as what the conventions require. It supplies the judgment about how code ought to look; carrying out a change whose shape is already decided is separate work.
description-claude: Answer "how should this be written here" from the project's recorded conventions rather than by inferring them from nearby code — what to name something, whether to split a module, what a function does with an error, how much to comment, which logging library to use and how to configure it, how to structure something new. Carries those conventions plus a per-language reference for TypeScript, JavaScript, React, React Native, Python, Go, Rust, Swift, Dart and Flutter. Reach for it whenever you are choosing between ways to write something, or judging whether existing code follows the conventions, including when the question names no language at all — "should this return null or throw", "should these be two modules or one", "this function has grown too long, how do I break it up", "what should I call this one", "what pattern do we use for errors here", "how much should I comment this". Surrounding code shows what was done, which is not the same as what the conventions require. It supplies the judgment about how code ought to look; carrying out a change whose shape is already decided is separate work.
description-codex: Answer "how should this be written here" from the project's recorded conventions rather than by inferring them from nearby code — what to name something, whether to split a module, what a function does with an error, how much to comment, which logging library to use and how to configure it, how to structure something new. Carries those conventions plus a per-language reference for TypeScript, JavaScript, React, React Native, Python, Go, Rust, Swift, Dart and Flutter. Reach for it whenever you are choosing between ways to write something, or judging whether existing code follows the conventions, including when the question names no language at all — "should this return null or throw", "should these be two modules or one", "this function has grown too long, how do I break it up", "what should I call this one", "what pattern do we use for errors here", "how much should I comment this". Surrounding code shows what was done, which is not the same as what the conventions require. It supplies the judgment about how code ought to look; carrying out a change whose shape is already decided is separate work.
---
...
| All | [references/common/logging.md](references/common/logging.md) | Choosing a logging library, or configuring what it emits and where it writes (levels, format, redaction, stdout vs a local file) |
