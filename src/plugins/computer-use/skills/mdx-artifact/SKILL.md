...
<!--@codex-->
- **The preview is a long-lived process.** In unified exec, run `mdxv doc.mdx --no-open` directly
  and **do not append `&`**. Let exec yield, keep the returned session id, and take
